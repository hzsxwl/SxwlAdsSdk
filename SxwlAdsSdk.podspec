...
TODO: Add long description of the pod here.
  ...
  s.dependency 'ToBid-iOS/GDTAdapter','4.6.9'
  s.dependency 'ToBid-iOS/BaiduAdapter','4.6.9'
  s.dependency 'ToBid-iOS/KSAdapter','4.6.9'
  s.dependency 'ToBid-iOS/TouTiaoAdapter','4.6.9'
  s.dependency 'ToBid-iOS/CSJMediationAdapter','4.6.9'
  s.dependency 'ToBid-iOS/AdScopeAdapter','4.6.9'
